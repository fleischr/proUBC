CLASS zcl_nchain DEFINITION PUBLIC.
* Generated by abap-openapi-client
* NChain_OG, 1.0
  PUBLIC SECTION.
    INTERFACES zif_nchain.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_createconnectorrequest
      ...
      RETURNING VALUE(createconnectorrequest) TYPE zif_nchain=>createconnectorrequest
      RAISING cx_static_check.
    METHODS parse_config
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(config) TYPE zif_nchain=>config
      RAISING cx_static_check.
    METHODS parse_credentials
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(credentials) TYPE zif_nchain=>credentials
      RAISING cx_static_check.
    METHODS parse_security
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(security) TYPE zif_nchain=>security
      RAISING cx_static_check.
    METHODS parse_ingress
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ingress) TYPE zif_nchain=>ingress
      RAISING cx_static_check.
    METHODS parse_m00000
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(m00000) TYPE zif_nchain=>m00000
      RAISING cx_static_check.
    METHODS parse_createnetworkrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createnetworkrequest) TYPE zif_nchain=>createnetworkrequest
      RAISING cx_static_check.
    METHODS parse_config1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(config1) TYPE zif_nchain=>config1
      RAISING cx_static_check.
    METHODS parse_chainspec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(chainspec) TYPE zif_nchain=>chainspec
      RAISING cx_static_check.
    METHODS parse_config2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(config2) TYPE zif_nchain=>config2
      RAISING cx_static_check.
    METHODS parse_createaccountsrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createaccountsrequest) TYPE zif_nchain=>createaccountsrequest
      RAISING cx_static_check.
    METHODS parse_createhdwalletrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createhdwalletrequest) TYPE zif_nchain=>createhdwalletrequest
      RAISING cx_static_check.
    METHODS parse_create&broadcasttransact
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(create&broadcasttransaction_ac) TYPE zif_nchain=>create&broadcasttransaction_ac
      RAISING cx_static_check.
    METHODS parse_create&broadcasttransa01
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(create&broadcasttransaction_wa) TYPE zif_nchain=>create&broadcasttransaction_wa
      RAISING cx_static_check.
    METHODS parse_deploycontractrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploycontractrequest) TYPE zif_nchain=>deploycontractrequest
      RAISING cx_static_check.
    METHODS parse_params
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(params) TYPE zif_nchain=>params
      RAISING cx_static_check.
    METHODS parse_compiledartifact
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(compiledartifact) TYPE zif_nchain=>compiledartifact
      RAISING cx_static_check.
    METHODS parse_abi
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi) TYPE zif_nchain=>abi
      RAISING cx_static_check.
    METHODS parse_input
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(input) TYPE zif_nchain=>input
      RAISING cx_static_check.
    METHODS parse_baselinedeployregistryco
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(baselinedeployregistrycontract) TYPE zif_nchain=>baselinedeployregistrycontract
      RAISING cx_static_check.
    METHODS parse_params1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(params1) TYPE zif_nchain=>params1
      RAISING cx_static_check.
    METHODS parse_compiledartifact1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(compiledartifact1) TYPE zif_nchain=>compiledartifact1
      RAISING cx_static_check.
    METHODS parse_abi1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi1) TYPE zif_nchain=>abi1
      RAISING cx_static_check.
    METHODS parse_input1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(input1) TYPE zif_nchain=>input1
      RAISING cx_static_check.
    METHODS parse_assembly
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(assembly) TYPE zif_nchain=>assembly
      RAISING cx_static_check.
    METHODS parse_code
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(code) TYPE zif_nchain=>code
      RAISING cx_static_check.
    METHODS parse_generatedobject
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(generatedobject) TYPE zif_nchain=>generatedobject
      RAISING cx_static_check.
    METHODS parse_generatedobject1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(generatedobject1) TYPE zif_nchain=>generatedobject1
      RAISING cx_static_check.
    METHODS parse_dep
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(dep) TYPE zif_nchain=>dep
      RAISING cx_static_check.
    METHODS parse_abi2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi2) TYPE zif_nchain=>abi2
      RAISING cx_static_check.
    METHODS parse_input2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(input2) TYPE zif_nchain=>input2
      RAISING cx_static_check.
    METHODS parse_output
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(output) TYPE zif_nchain=>output
      RAISING cx_static_check.
    METHODS parse_dep1
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(dep1) TYPE zif_nchain=>dep1
      RAISING cx_static_check.
    METHODS parse_abi3
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi3) TYPE zif_nchain=>abi3
      RAISING cx_static_check.
    METHODS parse_assembly2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(assembly2) TYPE zif_nchain=>assembly2
      RAISING cx_static_check.
    METHODS parse_dep2
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(dep2) TYPE zif_nchain=>dep2
      RAISING cx_static_check.
    METHODS parse_abi4
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi4) TYPE zif_nchain=>abi4
      RAISING cx_static_check.
    METHODS parse_input4
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(input4) TYPE zif_nchain=>input4
      RAISING cx_static_check.
    METHODS parse_dep3
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(dep3) TYPE zif_nchain=>dep3
      RAISING cx_static_check.
    METHODS parse_abi5
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(abi5) TYPE zif_nchain=>abi5
      RAISING cx_static_check.
    METHODS parse_executecontractrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(executecontractrequest) TYPE zif_nchain=>executecontractrequest
      RAISING cx_static_check.
    METHODS parse_executereadonlycontractr
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(executereadonlycontractrequest) TYPE zif_nchain=>executereadonlycontractrequest
      RAISING cx_static_check.
ENDCLASS.

CLASS zcl_nchain IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
...
* todo, array, params
  ...
  METHOD zif_nchain~listconnectors.
    DATA lv_code TYPE i.
  ...
  METHOD zif_nchain~createconnector.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/connectors'.
...
* todo, set body, #/components/schemas/CreateconnectorRequest
  ...
  METHOD zif_nchain~getconnectordetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~deleteconnector.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/connectors/{connector_id}'.
    lv_temp = connector_id.
  ...
  METHOD zif_nchain~updatenetwork.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/connectors/{connector_id}'.
    lv_temp = connector_id.
  ...
  METHOD zif_nchain~getloadbalancerdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~listnetworks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~getnetworkdetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~getnetworkstatus.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~createnetwork.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, set body, #/components/schemas/CreatenetworkRequest
  ...
  METHOD zif_nchain~createaccounts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, set body, #/components/schemas/CreateaccountsRequest
  ...
  METHOD zif_nchain~listaccounts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/accounts'.
    mi_client->request->set_method( 'GET' ).
  ...
  METHOD zif_nchain~getaccountdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~listhdwallets.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~createhdwallet.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/wallets'.
    mi_client->request->set_method( 'POST' ).
...
* todo, set body, #/components/schemas/CreateHDwalletRequest
  ...
  METHOD zif_nchain~listhdwalletaccounts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~listtransactions.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~create&broadcasttransaction_ac.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/transactions'.
    mi_client->request->set_method( 'POST' ).
  ...
  METHOD zif_nchain~gettransactiondetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~listcontracts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~deploycontract.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/contracts'.
    mi_client->request->set_method( 'POST' ).
...
* todo, set body, #/components/schemas/DeploycontractRequest
  ...
  METHOD zif_nchain~getcontractdetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_nchain~executecontract.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, set body, #/components/schemas/ExecutecontractRequest
  ...
  METHOD zif_nchain~executereadonlycontract.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
