CLASS zcl_privacy DEFINITION PUBLIC.
* Generated by abap-openapi-client
* Privacy, 1.0
  PUBLIC SECTION.
    INTERFACES zif_privacy.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_createcircuitrequest
      ...
      RETURNING VALUE(createcircuitrequest) TYPE zif_privacy=>createcircuitrequest
      RAISING cx_static_check.
    METHODS parse_proverequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(proverequest) TYPE zif_privacy=>proverequest
      RAISING cx_static_check.
    METHODS parse_verifyrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(verifyrequest) TYPE zif_privacy=>verifyrequest
      RAISING cx_static_check.
    METHODS parse_witness
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(witness) TYPE zif_privacy=>witness
      RAISING cx_static_check.
ENDCLASS.

CLASS zcl_privacy IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
  ...
  METHOD zif_privacy~listcircuits.
    DATA lv_code TYPE i.
  ...
  METHOD zif_privacy~createcircuit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/circuits'.
