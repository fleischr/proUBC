CLASS zcl_baseline DEFINITION PUBLIC.
* Generated by abap-openapi-client
* Baseline API, v1.0.0
  PUBLIC SECTION.
    INTERFACES zif_baseline.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_account
      ...
      RETURNING VALUE(account) TYPE zif_baseline=>account
      RAISING cx_static_check.
    METHODS parse_associateworkgroupuserre
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(associateworkgroupuserrequest) TYPE zif_baseline=>associateworkgroupuserrequest
      RAISING cx_static_check.
    METHODS parse_authenticationrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authenticationrequest) TYPE zif_baseline=>authenticationrequest
      RAISING cx_static_check.
    METHODS parse_authenticationresponse
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authenticationresponse) TYPE zif_baseline=>authenticationresponse
      RAISING cx_static_check.
    METHODS parse_baselinerecord
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(baselinerecord) TYPE zif_baseline=>baselinerecord
      RAISING cx_static_check.
    METHODS parse_businessobject
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(businessobject) TYPE zif_baseline=>businessobject
      RAISING cx_static_check.
    METHODS parse_chainspec
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(chainspec) TYPE zif_baseline=>chainspec
      RAISING cx_static_check.
    METHODS parse_circuit
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(circuit) TYPE zif_baseline=>circuit
      RAISING cx_static_check.
    METHODS parse_compiledartifact
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(compiledartifact) TYPE zif_baseline=>compiledartifact
      RAISING cx_static_check.
    METHODS parse_config
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(config) TYPE zif_baseline=>config
      RAISING cx_static_check.
    METHODS parse_connector
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(connector) TYPE zif_baseline=>connector
      RAISING cx_static_check.
    METHODS parse_connectorconfig
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(connectorconfig) TYPE zif_baseline=>connectorconfig
      RAISING cx_static_check.
    METHODS parse_contract
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contract) TYPE zif_baseline=>contract
      RAISING cx_static_check.
    METHODS parse_contractparams
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(contractparams) TYPE zif_baseline=>contractparams
      RAISING cx_static_check.
    METHODS parse_createsealorunsealkey
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createsealorunsealkey) TYPE zif_baseline=>createsealorunsealkey
      RAISING cx_static_check.
    METHODS parse_credentials
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(credentials) TYPE zif_baseline=>credentials
      RAISING cx_static_check.
    METHODS parse_deploycontract
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(deploycontract) TYPE zif_baseline=>deploycontract
      RAISING cx_static_check.
    METHODS parse_derivekeyrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(derivekeyrequest) TYPE zif_baseline=>derivekeyrequest
      RAISING cx_static_check.
    METHODS parse_error
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(error) TYPE zif_baseline=>error
      RAISING cx_static_check.
    METHODS parse_executecontractrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(executecontractrequest) TYPE zif_baseline=>executecontractrequest
      RAISING cx_static_check.
    METHODS parse_executecontractresponse
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(executecontractresponse) TYPE zif_baseline=>executecontractresponse
      RAISING cx_static_check.
    METHODS parse_ingress
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(ingress) TYPE zif_baseline=>ingress
      RAISING cx_static_check.
    METHODS parse_issueverifiablecredentia
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(issueverifiablecredential) TYPE zif_baseline=>issueverifiablecredential
      RAISING cx_static_check.
    METHODS parse_jwk
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(jwk) TYPE zif_baseline=>jwk
      RAISING cx_static_check.
    METHODS parse_key
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(key) TYPE zif_baseline=>key
      RAISING cx_static_check.
    METHODS parse_lastblockheader
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(lastblockheader) TYPE zif_baseline=>lastblockheader
      RAISING cx_static_check.
    METHODS parse_loadbalancer
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(loadbalancer) TYPE zif_baseline=>loadbalancer
      RAISING cx_static_check.
    METHODS parse_logmessage
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(logmessage) TYPE zif_baseline=>logmessage
      RAISING cx_static_check.
    METHODS parse_message
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(message) TYPE zif_baseline=>message
      RAISING cx_static_check.
    METHODS parse_network
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(network) TYPE zif_baseline=>network
      RAISING cx_static_check.
    METHODS parse_networkstatus
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(networkstatus) TYPE zif_baseline=>networkstatus
      RAISING cx_static_check.
    METHODS parse_openidconfig
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(openidconfig) TYPE zif_baseline=>openidconfig
      RAISING cx_static_check.
    METHODS parse_organization
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(organization) TYPE zif_baseline=>organization
      RAISING cx_static_check.
    METHODS parse_participant
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(participant) TYPE zif_baseline=>participant
      RAISING cx_static_check.
    METHODS parse_protocolmessage
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protocolmessage) TYPE zif_baseline=>protocolmessage
      RAISING cx_static_check.
    METHODS parse_protocolmessagepayload
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(protocolmessagepayload) TYPE zif_baseline=>protocolmessagepayload
      RAISING cx_static_check.
    METHODS parse_proverequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(proverequest) TYPE zif_baseline=>proverequest
      RAISING cx_static_check.
    METHODS parse_secret
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(secret) TYPE zif_baseline=>secret
      RAISING cx_static_check.
    METHODS parse_security
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(security) TYPE zif_baseline=>security
      RAISING cx_static_check.
    METHODS parse_token
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(token) TYPE zif_baseline=>token
      RAISING cx_static_check.
    METHODS parse_transaction
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(transaction) TYPE zif_baseline=>transaction
      RAISING cx_static_check.
    METHODS parse_unsealvaultrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(unsealvaultrequest) TYPE zif_baseline=>unsealvaultrequest
      RAISING cx_static_check.
    METHODS parse_user
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(user) TYPE zif_baseline=>user
      RAISING cx_static_check.
    METHODS parse_vault
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(vault) TYPE zif_baseline=>vault
      RAISING cx_static_check.
    METHODS parse_verifyproofrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(verifyproofrequest) TYPE zif_baseline=>verifyproofrequest
      RAISING cx_static_check.
    METHODS parse_wallet
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(wallet) TYPE zif_baseline=>wallet
      RAISING cx_static_check.
    METHODS parse_witness
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(witness) TYPE zif_baseline=>witness
      RAISING cx_static_check.
    METHODS parse_workgroup
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workgroup) TYPE zif_baseline=>workgroup
      RAISING cx_static_check.
    METHODS parse_workgroupconfig
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workgroupconfig) TYPE zif_baseline=>workgroupconfig
      RAISING cx_static_check.
    METHODS parse_workflow
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(workflow) TYPE zif_baseline=>workflow
      RAISING cx_static_check.
    METHODS parse_listconnectors
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_listconnectors) TYPE zif_baseline=>response_listconnectors
      RAISING cx_static_check.
    METHODS parse_listtokens
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_listtokens) TYPE zif_baseline=>response_listtokens
      RAISING cx_static_check.
    METHODS parse_listusers
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_listusers) TYPE zif_baseline=>response_listusers
      RAISING cx_static_check.
    METHODS parse_listworkgroups
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_listworkgroups) TYPE zif_baseline=>response_listworkgroups
      RAISING cx_static_check.
    METHODS parse_listworkgroupusers
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(response_listworkgroupusers) TYPE zif_baseline=>response_listworkgroupusers
      RAISING cx_static_check.
ENDCLASS.

CLASS zcl_baseline IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
...
* todo, array, parcicipants
  ...
  METHOD parse_listconnectors.
    ...
    DATA connector TYPE zif_baseline=>connector.
  ...
  METHOD parse_listtokens.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA token TYPE zif_baseline=>token.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR token.
  ...
  METHOD parse_listusers.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA user TYPE zif_baseline=>user.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR user.
  ...
  METHOD parse_listworkgroups.
    DATA lt_members TYPE string_table.
    DATA lv_member LIKE LINE OF lt_members.
    DATA workgroup TYPE zif_baseline=>workgroup.
    lt_members = mo_json->members( iv_prefix && '/' ).
    LOOP AT lt_members INTO lv_member.
      CLEAR workgroup.
  ...
  METHOD zif_baseline~listaccounts.
    DATA lv_code TYPE i.
...
" todo, raise
  ...
  METHOD zif_baseline~createaccount.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/accounts'.
...
" todo, raise
  ...
  METHOD zif_baseline~getaccountdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~authentication.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listconnectors.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createconnector.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/connectors'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~getconnectordetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~deleteconnector.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/connectors/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~getloadbalancerdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listcontracts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~deploycontract.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/contracts'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~getcontractdetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~executecontract.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listnetworks.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createnetwork.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/networks'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~updatenetwork.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~getnetworkstatus.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listoracles.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createoracle.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/oracles'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~getoracledetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~updateoracle.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/oracles/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~deleteoracle.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/oracles/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~listorganizations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createorganization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/organizations'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~getorganizationdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~updateorganizationdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/organizations/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~listtokens.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~tokenauthorization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/tokens'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~revoketoken.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listtransactions.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createtransaction.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/transactions'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~gettransactiondetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/users'.
    mi_client->request->set_method( 'POST' ).
...
" application/json,#/components/schemas/User
  ...
  METHOD zif_baseline~getuserdetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~updateuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/users/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~deleteuserrequest.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/users/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~unsealvault.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listvaults.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createvault.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/vaults'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~deriveakeyrequest.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~deleteakey.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listsecrets.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~storesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/vaults/{id}/secrets'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~retrievesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~deletesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/vaults/{id}/secrets/{secret_id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~listwallets.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createwallet.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/wallets'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~listwalletaccounts.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listworkgroups.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" application/json,#/components/schemas/response_listworkgroups
  ...
  METHOD zif_baseline~createworkgroup.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/workgroups'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~listworkgroupusers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~associateworkgroupuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/workgroups/{id}/users'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~getworkgroupdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~updateworkgroup.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/workgroups/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~deleteworkgroup.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/workgroups/{id}'.
    lv_temp = id.
...
" todo, raise
  ...
  METHOD zif_baseline~createbaselinebusinessobject.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~updatebaselinebusinessobject.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listcircuits.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~createcircuit.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://baseline.provide.network/circuits'.
    mi_client->request->set_method( 'POST' ).
...
" todo, raise
  ...
  METHOD zif_baseline~getstorevalue.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
" todo, raise
  ...
  METHOD zif_baseline~listwellknownkeys.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_baseline~listopenidconfiguration.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
