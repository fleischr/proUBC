...
CLASS Z100085_zcl_vault IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
  ...
  METHOD Z100085_zif_vault~createakey:c25519.
    DATA lv_code TYPE i.
  ...
  METHOD Z100085_zif_vault~listkeys.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://vault.provide.services/api/v1/vaults/{vault_id}/keys'.
    lv_temp = vault_id.
  ...
  METHOD Z100085_zif_vault~deriveakey:chacha20.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~deleteakey.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~listsecrets.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~retreivesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~deletesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://vault.provide.services/api/v1/vaults/{vault_id}/secrets/{secret_id}'.
    lv_temp = vault_id.
  ...
  METHOD Z100085_zif_vault~createvault.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~listvaults.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE 'https://vault.provide.services/api/v1/vaults'.
    mi_client->request->set_method( 'GET' ).
  ...
  METHOD Z100085_zif_vault~createseal_unsealkey.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_vault~unsealvault.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
