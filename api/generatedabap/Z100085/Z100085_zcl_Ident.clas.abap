CLASS Z100085_zcl_ident DEFINITION PUBLIC.
* Generated by abap-openapi-client
* Ident, 1.0
  PUBLIC SECTION.
    INTERFACES Z100085_zif_ident.
  ...
  PROTECTED SECTION.
    ...
    METHODS parse_createapplicationrequest
      ...
      RETURNING VALUE(createapplicationrequest) TYPE Z100085_zif_ident=>createapplicationrequest
      RAISING cx_static_check.
    METHODS parse_associateusertoapplicati
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(associateusertoapplicationrequ) TYPE Z100085_zif_ident=>associateusertoapplicationrequ
      RAISING cx_static_check.
    METHODS parse_updateapplicationrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(updateapplicationrequest) TYPE Z100085_zif_ident=>updateapplicationrequest
      RAISING cx_static_check.
    METHODS parse_createorganizationreques
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createorganizationrequest) TYPE Z100085_zif_ident=>createorganizationrequest
      RAISING cx_static_check.
    METHODS parse_updateorganizationdetail
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(updateorganizationdetailsreque) TYPE Z100085_zif_ident=>updateorganizationdetailsreque
      RAISING cx_static_check.
    METHODS parse_authorizelong_termtokenr
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authorizelong_termtokenrequest) TYPE Z100085_zif_ident=>authorizelong_termtokenrequest
      RAISING cx_static_check.
    METHODS parse_authenticationrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(authenticationrequest) TYPE Z100085_zif_ident=>authenticationrequest
      RAISING cx_static_check.
    METHODS parse_createuserrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(createuserrequest) TYPE Z100085_zif_ident=>createuserrequest
      RAISING cx_static_check.
    METHODS parse_updateuserrequest
      IMPORTING iv_prefix TYPE string
      RETURNING VALUE(updateuserrequest) TYPE Z100085_zif_ident=>updateuserrequest
      RAISING cx_static_check.
ENDCLASS.

CLASS Z100085_zcl_ident IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
  ...
  METHOD Z100085_zif_ident~createapplication.
    DATA lv_code TYPE i.
...
* todo, set body, #/components/schemas/CreateapplicationRequest
  ...
  METHOD Z100085_zif_ident~listapplications.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/applications'.
  ...
  METHOD Z100085_zif_ident~associateusertoapplication.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, set body, #/components/schemas/AssociateusertoapplicationRequest
  ...
  METHOD Z100085_zif_ident~listapplicationusers.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/applications/{application_id}/users'.
    lv_temp = application_id.
  ...
  METHOD Z100085_zif_ident~getapplicationdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~updateapplication.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/applications/{application_id}'.
    lv_temp = application_id.
...
* todo, set body, #/components/schemas/UpdateapplicationRequest
  ...
  METHOD Z100085_zif_ident~deleteapplication.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/applications/{application_id}'.
    lv_temp = application_id.
  ...
  METHOD Z100085_zif_ident~listorganizations.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~createorganization.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/organizations'.
    mi_client->request->set_method( 'POST' ).
...
* todo, set body, #/components/schemas/CreateorganizationRequest
  ...
  METHOD Z100085_zif_ident~getorganizationdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~updateorganizationdetails.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/organizations/{organization_id}'.
    lv_temp = organization_id.
...
* todo, set body, #/components/schemas/UpdateorganizationdetailsRequest
  ...
  METHOD Z100085_zif_ident~listtokens.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~authorizelong_termtoken.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/tokens'.
    mi_client->request->set_method( 'POST' ).
...
* todo, set body, #/components/schemas/Authorizelong-termtokenRequest
  ...
  METHOD Z100085_zif_ident~updateuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/tokens'.
    mi_client->request->set_method( 'PUT' ).
...
* todo, set body, #/components/schemas/UpdateuserRequest
  ...
  METHOD Z100085_zif_ident~revoketoken.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~authentication.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
...
* todo, set body, #/components/schemas/AuthenticationRequest
  ...
  METHOD Z100085_zif_ident~listuserscopy.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~createuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
    DATA lv_uri TYPE string VALUE '/api/v1/users'.
    mi_client->request->set_method( 'POST' ).
...
* todo, set body, #/components/schemas/CreateuserRequest
  ...
  METHOD Z100085_zif_ident~getuserdetail.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD Z100085_zif_ident~deleteuser.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
