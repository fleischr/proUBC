...
CLASS zcl_vault IMPLEMENTATION.
  METHOD constructor.
    mi_client = ii_client.
  ENDMETHOD.
  ...
  METHOD zif_vault~createakey:c25519.
    DATA lv_code TYPE i.
  ...
  METHOD zif_vault~deriveakey:chacha20.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_vault~retreivesecret.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
  ...
  METHOD zif_vault~createseal_unsealkey.
    DATA lv_code TYPE i.
    DATA lv_temp TYPE string.
